...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("OnboardingScreenState.Companion")))
@interface SharedOnboardingScreenStateCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedOnboardingScreenStateCompanion *shared __attribute__((swift_name("shared")));
@property (readonly) NSString *JSON_INPUT __attribute__((swift_name("JSON_INPUT")));
@end
